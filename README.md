...
## Changelog:
* Version 1.4
    * Use AWS [S3](https://aws.amazon.com/s3/) to store generated images: the image url generated by OpenAI has 2 hours of TTL. In a long term, to view those images in search history, we will have to download images and store them.
    * Add like/dislike button for user to submit feedback
    ...
    * Data sructure:
      ...
      |---|---|---|---|---|---|---|
      | email1  | Sat Apr.8th.2023 2:28:05pm  | ipsum  | true | http:ex.com/img  | true    | cat and dog |
      | email2 | Sun Apr.9th.2023 11:12:12am  | ipsum  | false | http:ex.com/img  |         | venus alien |
      ...
      * Story: 250 words story generated from OpenAI, store as a string
      * ImageUrl: pre signed image url from AWS S3, store as a string
      * StoryLike/ImageLike: boolean value, null for no feedback; store as a boolean, *optional*, could be empty
    ...
    * __TODO__:
      ...
      * add detailed search history page for each search result

    | ![user feedback](./image/user_feedback.png) |
    |:--:| 
    | *user feedback for story and image* |
    | ![search history](./image/search_history.png) |
    |:--:| 
    | *search history* |

    | ![dynamo db](./image/dynamoDB.png) |
    |:--:| 
    | *AWS Dynamo DB* |

    | ![s3 bucket](./image/s3_bucket.png) |
    |:--:| 
